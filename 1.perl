...
unless ($tcpto) {
    $tcpto = 5;
    print "4 second to tcp connection timeout.\n";
}
...
if ( $Config{usethreads} ) {
    ...
    print "Script will be slower than normal as a result.\n";
}
...
"That's odd - I connected but couldn't send the data to $host:$port.\n";
    ...
    if ( print $sock "Connection: Close\r\n\r\n" ) {
        print "Okay that's enough time. Script closed the socket.\n";
...
sub doconnections {
    ...
    while (1) {
        ...
        print
"Script has now sent $packetcount packets \n\n";
        sleep($timeout);
    }
}
